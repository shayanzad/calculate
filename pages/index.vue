<template>
  <div dir="rtl">
    ...
    >
      <div>
        <div>
          <p class="py-2 pb-5" style="line-height: 30px">
            <span class="block mb-2">مشتری گرامی</span>
            نسبت به تکمیل اطلاعات حمل در فرم زیر اقدام کنید پس از محاسبه دقیق
            کرایه و وارد کردن اطلاعات خواسته شده درخواست خود را ثبت و پس از
            بررسی و در صورت امکان اریه خدمات با شما تماس حاصل میگردد . لطفا فرم
            زیر را با دقت تکمیل نمایید زیرا مسئولیت و عواقب درج اطلاعات نا صحیح
            بار مالی داشته که بر عهده شما میباشد .
          </p>
        </div>
          ...
          <v-col cols="4">
            <div class="border-2 border-[#64748b8a] rounded-md p-4">
              ...
              <div class="mb-2">
                ...
                <span>
                  {{
                    calculatedForm.additionalInsuranceOfTheDriver.toLocaleString(
                      "en-US"
                    )
                  }}
                  <span class="text-gray-500">ریال</span>
              ...
              <div class="mb-2">
                ...
                <span>
                  {{
                    (
                      calculatedForm.fareLimits +
                      calculatedForm.additionalInsuranceOfTheDriver +
                      calculatedForm.comistion +
                      calculatedForm.complications +
                      calculatedForm.insurancePremium
                    ).toLocaleString("en-US")
                  }}
                  <span class="text-gray-500">ریال</span>
                </span>
        ...
        <v-row>
          <v-col cols="8">
            <div class="border-2 !border-[#f5a700] p-4 rounded-md">
              ...
              <div class="mb-3">
                <span>
                  <v-icon class="text-gray-400">mdi-cash</v-icon> حدود کرایه
                  پایه:
                </span>
                <span class="text-lg">
                  <!-- {{
